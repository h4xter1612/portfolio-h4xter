...
/**
 * Domain / Area (what the project is about)
 * Use this for the main filter row.
 */
...
/**
 * Modality / Work type (what you did)
 * Use this for a secondary filter row.
 */
...
export interface ProjectLinks {
  github?: string;
  pdf?: PdfLink; // local (/docs/...) o externo (Drive, etc.)
...
export interface Project {
  ...
  /**
   * MAIN label (Domain/Area)
   */
  category: ProjectCategory;

  /**
   * SECONDARY labels (Work type / modality)
   */
  types: ProjectType[];

  /**
   * Optional micro-tags for future search or chips
   */
  tags?: string[];
...
export const projects: Project[] = [
  {
    ...
    types: ["Simulation", "Software", "Data Analysis"],
    tags: ["MHD", "Resistive MHD", "Z-Pinch", "Instabilities", "Sausage", "Kink"],
...

  {
    ...
    category: "Fusion & Plasma",
    types: ["Simulation", "Software", "Data Analysis"],
    tags: ["PIC", "Two-Stream", "Electrostatic", "Phase Space", "Periodic BCs"],
...

  {
    ...
    category: "Fusion & Plasma",
    types: ["Simulation", "Software", "Data Analysis"],
    tags: ["Two-Fluid", "Waves", "Dispersion", "1D", "2D"],
...

  {
    ...
    category: "Fusion & Plasma",
    types: ["Simulation", "Software", "Data Analysis"],
    tags: ["Grad–Shafranov", "Equilibrium", "FreeGSNKE", "Tokamak", "Diagnostics", "q-profile"],
...

  {
    ...
    category: "Applied Math / Theory",
    types: ["Theory / Derivation"],
    tags: ["MHD", "Equilibrium", "Grad–Shafranov", "Axisymmetry", "Vector Calculus"],
...

  {
    ...
    types: ["Engineering Design", "Simulation", "Experiment"],
    tags: ["HFSS", "S11", "Fractal Antenna", "CubeSat", "KiCad", "Rogers", "FR4"],
...

  {
    ...
    types: ["Simulation", "Software", "Data Analysis"],
    tags: ["Geant4", "Monte Carlo", "CT", "DICOM", "Dual-energy", "Radon"],
...

  {
    ...
    types: ["Experiment", "Data Analysis"],
    tags: ["Fringe Projection", "FTP", "FFT", "Phase Unwrapping", "3D Reconstruction"],
    ...
    links: {
      pdf: {
        en: "/docs/profilometry-en.pdf",
        es: "/docs/profilometry-es.pdf",
      },
    },
  },

  {
    ...
    category: "Optics & Photonics",
    types: ["Simulation", "Data Analysis", "Software"],
    tags: ["NLSE", "Dispersion", "Nonlinearity", "Spectral Methods", "Fiber Optics"],
    ...
    links: {
      pdf: {
        en: "/docs/pulse-en.pdf",
        es: "/docs/pulse-es.pdf",
      },
    },
  },

  {
    ...
    category: "Materials & Vacuum",
    types: ["Engineering Design", "Data Analysis"],
    tags: ["Vacuum", "Feedthroughs", "CNT", "Materials Characterization", "Instrumentation"],
    ...
    links: {
      pdf: {
        en: "/docs/materials-en.pdf",
        es: "/docs/materials-es.pdf",
      },
    },
  },

  {
    ...
    category: "Optics & Photonics",
    types: ["Engineering Design", "Simulation", "Experiment"],
    tags: ["Telescope", "Optical Design", "Alignment", "Prototyping", "Simulation"],
    ...
    technologies: ["Optical Design", "Mechanical Design (CAD)", "Simulation", "Prototyping"],
    links: {
      pdf: {
        en: "/docs/stargazer-en.pdf",
        es: "/docs/stargazer-es.pdf",
      },
    },
  },

  {
    ...
    category: "Optics & Photonics",
    types: ["Experiment", "Data Analysis"],
    tags: ["Interferometry", "Mach–Zehnder", "Polarization", "Optical Path", "Fringes"],
    ...
    technologies: ["Optics Lab", "Interferometry", "Polarization Optics", "Optical Filters", "MATLAB"],

    links: {
      pdf: {
        en: "/docs/mach-zehnder-en.pdf",
        es: "/docs/mach-zehnder-es.pdf",
      },
    },
  },
];
