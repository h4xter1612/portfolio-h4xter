        ...
        >
          ...
          >
            <button
              ...
              className="absolute right-4 top-4 z-10 inline-flex h-11 w-11 items-center justify-center rounded-full
                         bg-slate-950/70 text-slate-100 ring-1 ring-slate-700/70 backdrop-blur
                         transition hover:bg-slate-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-400/70"
            >
              <X className="h-5 w-5" />
            </button>
